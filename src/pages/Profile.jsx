            ...
            {showQr && (
              ...
              >
                <div className="bg-white p-3 rounded-xl border border-gray-700 shadow-[0_0_30px_rgba(0,198,255,0.2)]">
                  {/* Mock QR Code image generated via generic placeholder for representation */}
                  <div className="w-32 h-32 bg-gray-200 rounded flex items-center justify-center border border-gray-300">
